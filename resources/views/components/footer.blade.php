        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div class="space-y-6">
                ...
                <ul class="space-y-3 text-sm">
                    <li><a href="{{ url('/') }}" class="hover:text-[#738029] transition flex items-center gap-2 group">
                        <span class="w-0 group-hover:w-2 h-[1px] bg-[#738029] transition-all"></span> Home</a>
                    </li>
                    <li><a href="{{ url('/produk') }}" class="hover:text-[#738029] transition flex items-center gap-2 group">
                        <span class="w-0 group-hover:w-2 h-[1px] bg-[#738029] transition-all"></span> Koleksi Produk</a>
                    </li>
                    <li><a href="{{ url('/keranjang') }}" class="hover:text-[#738029] transition flex items-center gap-2 group">
                        <span class="w-0 group-hover:w-2 h-[1px] bg-[#738029] transition-all"></span> Keranjang</a>
                    </li>
                    <li><a href="#" class="hover:text-[#738029] transition flex items-center gap-2 group">
            ...
            <div class="space-y-6">
                ...
                <ul class="space-y-3 text-sm">
                    <li><a href="#" class="hover:text-[#738029] transition">Hubungi Kami</a></li>
                    <li><a href="#" class="hover:text-[#738029] transition">Panduan Belanja</a></li>
                    <li><a href="#" class="hover:text-[#738029] transition">Kebijakan Privasi</a></li>
                    <li><a href="#" class="hover:text-[#738029] transition">Syarat & Ketentuan</a></li>
                </ul>
            </div>
