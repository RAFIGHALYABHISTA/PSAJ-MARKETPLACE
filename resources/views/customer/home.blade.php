...
<section class="bg-[#FFEADB] w-full px-6 lg:px-16 py-16 grid md:grid-cols-2 gap-10 items-center overflow-hidden">
    <div class="space-y-6 animate-fade-in-left">
        ...
        <div class="flex flex-wrap gap-4">
            <a href="#" class="bg-green-700 text-white px-7 py-3 rounded-full text-sm font-semibold hover:bg-green-800 transition-all shadow-lg hover:shadow-green-900/20 active:scale-95">
...
<section class="relative bg-[#E9DADA] py-24 px-6 overflow-hidden">
    ...
    <div class="max-w-6xl mx-auto relative">
        ...
        <div class="text-center mb-20">
            ...
            <p class="text-[#000000] text-lg">
                Setiap tetes produk kami memiliki bahan pilihan yang berkualitas premium, dipetik dengan cermat dari kekayaan alam Nusantara hingga berbagai penjuru dunia, menghadirkan sentuhan kemewahan alami yang merawat kulit dengan kelembutan dan keanggunan.
            </p>
        </div>
        ...
        <div id="slider" class="flex transition-transform duration-500">
            ...
            <div class="min-w-full grid md:grid-cols-2 gap-16 items-center">
                <div class="bg-white rounded-2xl shadow-lg p-8 max-w-md">
                    <h3 class="font-semibold text-lg">Buah Langsat (Lansium domesticum)</h3>
            ...
            <div class="min-w-full grid md:grid-cols-2 gap-16 items-center">
                ...
                <div class="bg-white rounded-2xl shadow-lg p-8 max-w-md">
                    <h3 class="font-semibold text-lg">Pegagan (Centella asiatica)</h3>
                    <p class="text-gray-600 text-sm mt-3">
            ...
            <div class="min-w-full grid md:grid-cols-2 gap-16 items-center">
                <div class="bg-white rounded-2xl shadow-lg p-8 max-w-md">
                    <h3 class="font-semibold text-lg">Bunga Kenanga</h3>
                    <p class="text-gray-600 text-sm mt-3">
            ...
            <div class="min-w-full grid md:grid-cols-2 gap-16 items-center">
                ...
                <div class="bg-white rounded-2xl shadow-lg p-8 max-w-md">
                    <h3 class="font-semibold text-lg">Lidah Buaya</h3>
                    <p class="text-gray-600 text-sm mt-3">
...
<section class="bg-stone-50 py-24">
    ...
    <div class="mb-16">
        ...
        <p class="text-gray-600 mt-3 max-w-xl mx-auto">
            Temukan berbagai promo menarik dan penawaran terbaik untuk Anda.
        </p>
    </div>
    ...
    <div class="relative overflow-hidden">
        ...
        <div id="promoSlider" class="flex transition-all duration-700">
            ...
            <div class="min-w-full flex flex-col items-center gap-6">
                <div class="flex justify-center">
                    <img src="{{ asset('images/promo1.png') }}" class="h-72 w-auto">
                </div>
            ...
            <div class="min-w-full flex flex-col items-center gap-6">
                <div class="flex justify-center">
                    <img src="{{ asset('images/promo2.png') }}" class="h-72 w-auto">
                </div>
                <p class="text-gray-500 text-sm">
            ...
            <div class="min-w-full flex flex-col items-center gap-6">
                <div class="flex justify-center">
                    <img src="{{ asset('images/promo3.png') }}" class="h-72 w-auto">
                </div>
                <p class="text-gray-500 text-sm">
                    Penawaran terbaik pilihan
                </p>
            </div>
    ...
    <div class="flex justify-center gap-3 mt-8">
        <button onclick="slidePromo(0)" class="dotPromo w-3 h-3 rounded-full bg-green-600"></button>
        <button onclick="slidePromo(1)" class="dotPromo w-3 h-3 rounded-full bg-gray-400"></button>
        <button onclick="slidePromo(2)" class="dotPromo w-3 h-3 rounded-full bg-gray-400"></button>
    </div>
          ...
          {{-- <div class="flex justify-center">
              <img src="{{ asset('images/zahira.jpg') }}"
                   class="w-full max-w-sm rounded-3xl shadow-2xl hover:scale-105 transition duration-500">
          </div> --}}
            ...
            <div class="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
                <div>
                    ...
                    <p class="text-stone-500 text-lg italic">
                        Pilih perawatan terbaik untuk pancaran kulit sehatmu.
                    </p>
                </div>

                <div class="flex gap-4 p-1 bg-stone-200 rounded-full">
                    <button class="bg-[#B96710] text-white px-8 py-3 rounded-full text-xs font-bold shadow-lg shadow-orange-900/20 hover:scale-105 transition">
                        NEW PRODUCT
                    </button>
                    <button class="text-stone-600 px-8 py-3 rounded-full text-xs font-bold hover:bg-stone-300 transition">
                        BEST SELLER
                    </button>
                </div>
            </div>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function(){
        ...
        const dots = document.querySelectorAll(".dotPromo");
        ...
        function updateSlider(){
            slider.style.transform = `translateX(-${indexPromo * 100}%)`;

            dots.forEach(dot => dot.classList.remove("bg-green-500"));
            dots.forEach(dot => dot.classList.add("bg-gray-600"));

            dots[indexPromo].classList.remove("bg-gray-600");
            dots[indexPromo].classList.add("bg-green-500");
        }
...
function closePopup(e) {
    // hanya close jika klik di luar (overlay)
    if (e.target.id === "popupIklan") {
        document.getElementById("popupIklan").style.display = "none";
    }
}

// auto muncul saat load
