...
@section('content')
<section class="w-full h-screen object-cover">
  <img src="{{ asset('images/beuty.png') }}"
       class="w-full h-[400px] md:h-[500px] object-cover ">
</section>
<section class="bg-[#E6D3B5] py-20 px-6">
  <div class="max-w-6xl mx-auto space-y-20">
    ...
    <div class="grid md:grid-cols-2 gap-10 items-center">
      ...
      <div class="flex justify-end">
        <div class="bg-gray-300 rounded-[30px] p-3">
    ...
    <div class="grid md:grid-cols-2 gap-10 items-center">
      ...
      <div class="flex justify-start">
        <div class="bg-orange-700 rounded-[30px] p-3">
    ...
    <div class="grid md:grid-cols-2 gap-10 items-center">
      ...
      <!-- IMAGE -->
      <div class="flex justify-end">
        <div class="bg-blue-400 rounded-[30px] p-3">
...
<section class="bg-[#F5F5F5] py-20 px-6">
  <div class="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
    ...
    <div>
      ...
      <ol class="list-decimal ml-5 text-gray-700 space-y-2 text-sm leading-relaxed ml-20">
      ...
      <!-- BOX LOGO -->
      <div class="mt-8  inline-block p-6 ml-30">
