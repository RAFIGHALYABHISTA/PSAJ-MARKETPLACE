...
@section('content')
    ...
    <section class="relative bg-[#F9F1E7] overflow-hidden py-16 sm:py-20 px-4 sm:px-6 lg:px-6">
        <div class="absolute top-0 right-0 w-48 sm:w-64 h-48 sm:h-64 bg-green-800/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 pointer-events-none"></div>
        <div class="absolute bottom-0 left-0 w-72 sm:w-96 h-72 sm:h-96 bg-[#B96710]/5 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2 pointer-events-none"></div>
    ...
    <section class="px-4 sm:px-6 lg:px-6 py-12 min-h-screen bg-stone-50">
        <div class="max-w-7xl mx-auto flex flex-col lg:flex-row gap-10">
            ...
            <div class="w-full lg:w-72 shrink-0 mx-auto lg:mx-0">
                <details open class="group bg-white rounded-2xl shadow-sm border border-stone-100 overflow-hidden lg:sticky lg:top-32">
            ...
            <div class="flex-1">
                <div class="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
                    ...
                    <div class="relative group w-full md:w-80">
                        ...
                        <a href="#" class="w-8 h-8 rounded-full border border-stone-200 text-stone-400 hover:bg-[#738029] hover:border-[#738029] hover:text-white transition-colors flex items-center justify-center">
                ...
                <div id="productGrid" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                    ...
                    <div class="product-card group" data-category="{{ $prod->category ?? 'uncategorized' }}" data-price="{{ $prod->price }}" data-name="{{ strtolower($prod->name) }}">
                        <div class="bg-white rounded-[20px] p-4 border border-stone-100 shadow-[0_2px_15px_rgba(0,0,0,0.03)] hover:shadow-[0_10px_30px_rgba(0,0,0,0.08)] hover:-translate-y-1 transition-all duration-300 h-full flex flex-col">
                            ...
                            <div class="bg-[#F9F1E7] rounded-[15px] h-40 sm:h-48 flex items-center justify-center mb-4 relative overflow-hidden">
