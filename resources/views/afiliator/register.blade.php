        ...
        <div class="max-w-3xl mx-auto">
            <div class="text-center mb-16">
                ...
                <p class="text-stone-600 dark:text-stone-400 max-w-xl mx-auto leading-relaxed">
                    Wujudkan jiwa entrepreneurship Anda dan raih komisi eksklusif dengan merekomendasikan produk kecantikan
            ...
            <div
                ...
                <div class="bg-[#2D1B0E] px-10 py-8 text-white relative overflow-hidden">
                    ...
                    <p class="text-stone-400 text-sm mt-1 relative z-10 font-light">Lengkapi data untuk aktivasi dashboard
                        afiliasi Anda.</p>
                </div>
                ...
                @if (session('error') || $errors->any())
                    <div class="mb-6 p-4 bg-red-100 border-l-4 border-red-500 text-red-700">
                        <p class="font-bold">Mohon periksa kembali pendaftaran Anda:</p>
                ...
                <form action="{{ route('afiliator.store') }}" method="POST" class="p-10 space-y-8">
                    ...
                    <div>
                        <div class="flex items-center space-x-3 mb-6">
                            <span
                                class="w-8 h-8 rounded-full bg-stone-100 dark:bg-stone-800 flex items-center justify-center text-[#2D1B0E] dark:text-stone-300 text-xs font-bold">01</span>
                            <h3 class="text-sm font-black uppercase tracking-widest text-stone-800 dark:text-white">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-2">
                                <label class="text-[11px] font-bold text-stone-500 uppercase tracking-tight ml-1">WhatsApp /
                    ...
                    <div class="pt-8 border-t border-stone-100 dark:border-stone-800">
                        <div class="flex items-center space-x-3 mb-6">
                            <span
                                class="w-8 h-8 rounded-full bg-stone-100 dark:bg-stone-800 flex items-center justify-center text-[#2D1B0E] dark:text-stone-300 text-xs font-bold">02</span>
                            <h3 class="text-sm font-black uppercase tracking-widest text-stone-800 dark:text-white">Tujuan
                                Pencairan Komisi</h3>
                        </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="space-y-2">
                                <label class="text-[11px] font-bold text-stone-500 uppercase tracking-tight ml-1">Nomor
                    ...
                    <div class="pt-8 border-t border-stone-100 dark:border-stone-800 space-y-4">
                        <label class="flex items-start gap-3 cursor-pointer">
                            ...
                            <div
                                class="flex items-center justify-center w-5 h-5 rounded border-2 border-stone-300 bg-white peer-checked:bg-[#738029] peer-checked:border-[#738029] transition-all">
                            ...
                            <span class="text-xs text-stone-600 dark:text-stone-400 leading-relaxed">
                                Saya menyetujui Kode Etik dan Syarat & Ketentuan sebagai Afiliator Sariayu Smega <span
                    ...
                    <div class="pt-10 flex flex-col md:flex-row gap-4">
                        ...
                        <button type="submit"
                            class="flex-[2] px-8 py-4 bg-[#738029] hover:bg-[#5B2C04] text-white rounded-2xl font-black text-sm transition-all shadow-xl shadow-[#738029]/20 active:scale-[0.98] uppercase tracking-[0.2em]">
            ...
            <div class="mt-24 grid grid-cols-1 md:grid-cols-2 gap-8">
                <div
                    ...
                    <p class="text-sm text-stone-500 leading-relaxed">Jadilah yang pertama mencoba dan mempromosikan produk
                        terbaru dari Sariayu Martha Tilaar.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-sm text-stone-500 leading-relaxed">Dapatkan sesi mentoring khusus tentang strategi
                        digital marketing dan branding.</p>
                </div>
            </div>
        </div>
    </div>
